    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        {activeSessions && activeSessions.length > 0 && (
          <div className="mb-8 rounded-2xl bg-white shadow-sm p-5">
              ...
              {activeSessions.map((s) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="rounded-lg bg-indigo-50 px-2 py-0.5 font-mono text-sm font-bold tracking-widest text-indigo-700">
                      {s.code}
                    </span>
        ...
        {!isLoading && quizzes?.length === 0 && (
          <div className="rounded-2xl bg-white shadow-sm p-12 text-center">
            ...
            <h2 className="text-lg font-semibold text-gray-900">No quizzes yet</h2>
            ...
            {quizzes.map((quiz) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  <h2 className="truncate text-base font-semibold text-gray-900">{quiz.title}</h2>
                  {quiz.description && (
                  ...
                  <div className="mt-auto pt-4">
                    <div className="flex gap-2 border-t border-gray-100 pt-4">
                      <button
                        ...
                        className="rounded-xl bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-100 transition-colors"
                      >
                        Edit
                      </button>
                      <button
                      ...
                      <button
                        ...
                        className="rounded-xl border border-gray-200 px-3 py-2 text-sm text-gray-500 transition hover:border-red-200 hover:bg-red-50 hover:text-red-600"
                      >
                        Delete
                      </button>
                    </div>
                  ...
                  {quiz.sessions && quiz.sessions.length > 0 && (
                    <div className="mt-4 border-t border-gray-100 pt-3 space-y-1.5">
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400">Past sessions</p>
                      {quiz.sessions.map((s) => (
                        <div key={s.id} className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <span className="rounded-lg bg-gray-100 px-1.5 py-0.5 font-mono text-xs font-semibold text-gray-600">
                              {s.code}
                            </span>
                            {s.finishedAt && (
