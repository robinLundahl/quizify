                    ...
                    <div className="absolute top-2 right-2 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                      ...
                      {quiz.coverImage && (
                        <button
                          ...
                          disabled={isUploading}
                          onClick={() => updateCover.mutateAsync({ id: quiz.id, coverImage: null })}
                          className="flex h-7 w-7 items-center justify-center rounded-lg bg-black/50 text-white backdrop-blur-sm hover:bg-red-600/80 transition-colors disabled:opacity-50"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-3.5 w-3.5">
