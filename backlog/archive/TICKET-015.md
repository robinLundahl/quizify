...
## Acceptance Criteria
- [x] Clicking "Delete" opens a modal (no native `confirm()` call)
- [x] The modal clearly states which quiz will be deleted and asks for confirmation
- [x] The modal has a "Cancel" button that closes it without deleting
- [x] The modal has a destructive "Delete" button that proceeds with deletion
- [x] The modal follows the existing design system (colours, typography, spacing, button styles)
