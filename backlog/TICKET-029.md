...
## Acceptance Criteria
- [ ] In the host view, question images display the full image without cropping
- [ ] In the player view (JoinView), question images display the full image without cropping
- [ ] Images do not overflow their containers or push layout elements out of place
- [ ] The fix does not affect avatar images elsewhere (those correctly use `object-cover`)
