...
Allow users to redeem a post-rental discount offer to purchase a quiz at 20% off. The offer can be applied from the dashboard notification or from the quiz listing page. Once redeemed or expired, the offer cannot be used again.
...
- [ ] Redemption initiates a Stripe PaymentIntent at the discounted price (platform still takes 10% of the discounted amount)
